...
Author: Alex Nguyen
Date Created: 5/3/26
Date Modified: 5/3/26
Version: 4.00
Description: JS for HW4 MIS 3371
*/
...
//Retrieves value of a cookie by name.
...
var inputs = [
    ...
    {id: "mname", name: "middleInitial"},
    {id: "lname", name: "lastName"},
    {id: "dob", name: "dob"},
    {id: "ssn", name: "ssn"},
    {id: "address1", name: "address1"},
    {id: "city", name: "city"},
    {id: "zcode", name: "zipCode"},
    {id: "email", name: "email"},
    {id: "phone", name: "phone"},
...
//greet user with name and message if cookie is set
...
// Toggles cookie storage based on the "Remember Me" checkbox
...
// Removes stored cookies by setting their expiration date to the past
...
// Ensures cookies are deleted if "Remember Me" is unchecked when the page loads
